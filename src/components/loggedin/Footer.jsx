    ...
    return (
        <div>
            <div class="container mx-auto p-4">
                <h1 class="text-2xl font-bold mb-4 text-teal-400">Company List</h1>
                                ...
                                <>
                                    <div class="max-w-md mx-auto bg-white shadow-md rounded-md overflow-hidden">
                                        <div class="p-4">
                                            ...
                                            <p class="text-gray-600 mb-4">{i.details}</p>
            ...
            <div id="cardsContainer" class="flex flex-wrap justify-center items-center mt-10"></div>
            <footer className=" dark:bg-gray-900 bg-slate-200 ">
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            <Link to="/" className="flex items-center">

                                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ASB Design</span>
                            </Link >
                            <p>Phone: ######</p>
                            <p>Email: ###gmail..com</p>
